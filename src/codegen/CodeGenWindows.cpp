...
//         out << "    sub rsp, " << size << "\n";
//     }
//     void CodeGenWindows::emitEpilogue(std::unique_ptr<ASTNode> blockNode) {
...
//                  << out.str() << "END\n\n";
//     }
//     std::string CodeGenWindows::generateFunctionCall(std::unique_ptr<ASTNode> node) {
//         return "";
//     }
//     void CodeGenWindows::generateFunctionDeclaration(std::unique_ptr<ASTNode> node) {}
//     void CodeGenWindows::generateExternFunctionDeclaration(std::unique_ptr<ASTNode> node) {}
// }  // namespace zlang