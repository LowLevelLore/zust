...
class NameMapper
    ...
    public:
        ...
        {
            std::string mangled = name + "___" + scopeName + "___v" + std::to_string(varCounter_++);
            return mangled;
        }

        inline std::string mapFunction(const std::string &name, const std::string &scopeName)
        {
            std::string mangled = name + "___" + scopeName + "___f" + std::to_string(funcCounter_++);
            return mangled;
        }

        inline std::string mapType(const std::string &name, const std::string &scopeName)
        {
            std::string mangled = name + "___" + scopeName + "___t" + std::to_string(typeCounter_++);
            return mangled;
        }
